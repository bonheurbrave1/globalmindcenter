        ...
        >
          <div className="p-8">
            <div className="flex items-center mb-6">
              <div className="p-3 rounded-full bg-blue-50 text-blue-300 mr-4">
                <Zap size={24} />
              </div>
            ...
            <Link to="/enroll">
              <button className="w-full bg-gradient-to-r from-blue-500 to-blue-300 text-white py-3 px-6 rounded-lg font-semibold hover:from-blue-300 hover:to-blue-700 transition-all transform hover:-translate-y-1">
                Enroll Now
              </button>
            </Link>
          </div>
            ...
            {pricing.paymentOptions.map((option, index) => (
              <div key={index} className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                <div className="flex items-center">
                  <div className="bg-blue-100 text-blue-300 p-2 rounded-full mr-3">
                    <Award size={18} />
                  </div>
