...
const PMIRiskManagementProfessional = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-96 overflow-hidden">
        <img 
          ...
          alt="Risk Management Professional" 
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-blue-950/70 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">PMI Risk Management Professional (PMI-RMP)®</h1>
            <p className="text-xl max-w-3xl mx-auto">Specializes in identifying, assessing, and mitigating project risks, enhancing your ability to ensure project success.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="mb-16 relative">
          ...
          <p className="text-lg text-gray-700 leading-relaxed bg-white p-6 rounded-lg shadow-md">
            To prepare risk management professionals to pass the PMI-RMP exam and develop expertise in project risk management processes, from identification and analysis to response planning and monitoring.
          </p>
        </section>
        ...
        <section className="mb-16 relative">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {['Risk Managers', 'Project Managers', 'Project Controls Specialists', 'Program Managers', 'Project Sponsors', 'Quality Assurance Professionals'].map((item, index) => (
        ...
        <section className="mb-16 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Risk Strategy & Planning', desc: 'Developing risk management plans and strategies' },
              { title: 'Risk Identification', desc: 'Techniques for comprehensive risk identification' },
              { title: 'Qualitative Risk Analysis', desc: 'Prioritizing risks based on probability and impact' },
              { title: 'Quantitative Risk Analysis', desc: 'Numerical analysis of risk impact on project objectives' },
              { title: 'Risk Response Planning', desc: 'Developing strategies for threats and opportunities' },
              { title: 'Risk Monitoring & Control', desc: 'Implementing risk responses and monitoring residuals' }
            ].map((component, index) => (
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span>Secondary degree with 4,500 hours of project risk management experience</span>
              </li>
              <li className="flex items-start">
                <span className="bg-blue-600 text-white p-1 rounded-full mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>OR Bachelor's degree with 3,000 hours of project risk management experience</span>
              </li>
              <li className="flex items-start">
                <span className="bg-blue-600 text-white p-1 rounded-full mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>30 hours of project risk management education</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="text-center py-10 px-4 bg-blue-950 rounded-xl text-white">
          <h2 className="text-2xl font-bold mb-6">Ready to Advance Your Risk Management Career?</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg transition-colors flex items-center justify-center">
              Enroll in PMI-RMP Preparation Course
            </button>
            <button className="bg-white hover:bg-blue-50 text-blue-950 font-bold py-3 px-8 rounded-lg transition-colors border border-blue-200 flex items-center justify-center">
              Download Risk Management Toolkit
            </button>
          </div>
          <p className="mt-6 text-blue-200">Start your journey to becoming a certified Risk Management Professional today</p>
        </section>
      </div>
    </div>
  );
...
export default PMIRiskManagementProfessional;