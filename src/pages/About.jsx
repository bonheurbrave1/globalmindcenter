      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                ...
                <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                  <h2 className="text-xl font-semibold text-gray-900 mb-3 flex items-center">
                    <FaChalkboardTeacher className="mr-2 text-blue-950" />
                    Our Approach
                  </h2>
                  <p>
                    We combine{" "}
        ...
        <section className="mb-20">
          ...
          >
            ...
            Your Partner in Capacity Building-Training and consultant
            </h2>
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="p-8 bg-gradient-to-br from-blue-50 to-white flex flex-col items-center text-center lg:text-left">
                  <div className="relative mb-6">
                    ...
                    />
                    <div className="absolute -bottom-3 -right-3 bg-blue-950 text-white p-2 rounded-full">
                      <FaUserTie size={20} />
                    </div>
                  </div>
