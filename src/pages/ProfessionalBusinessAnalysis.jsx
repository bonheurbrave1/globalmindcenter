    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-96 overflow-hidden">
        <img 
          ...
          alt="Professional in Business Analysis" 
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-blue-950/70 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Professional in Business Analysis (PBA)®</h1>
            <p className="text-xl max-w-3xl mx-auto">Focuses on business analysis and requirements management within projects, programs, and portfolios.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="mb-16 relative">
          ...
          <p className="text-lg text-gray-700 leading-relaxed bg-white p-6 rounded-lg shadow-md">
            To equip business analysis professionals with the skills and knowledge necessary to pass the PMI-PBA exam and excel in requirements management, stakeholder engagement, and business solution evaluation.
          </p>
        </section>
        ...
        <section className="mb-16 relative">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {['Business Analysts', 'Requirements Managers', 'Project Managers performing BA duties', 'Product Owners', 'Systems Analysts'].map((item, index) => (
        ...
        <section className="mb-16 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Needs Assessment', desc: 'Techniques for identifying business problems and opportunities' },
              { title: 'Planning & Monitoring', desc: 'Developing comprehensive business analysis plans' },
              { title: 'Elicitation & Analysis', desc: 'Requirements gathering through workshops, interviews, and user stories' },
              { title: 'Traceability & Monitoring', desc: 'Managing requirements throughout the project lifecycle' },
              { title: 'Solution Evaluation', desc: 'Assessing solution performance and business value delivery' },
              { title: 'Exam Preparation', desc: 'Practice tests, exam strategies, and application guidance' }
            ].map((component, index) => (
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span>Secondary degree with 7,500 hours of business analysis experience</span>
              </li>
              <li className="flex items-start">
                <span className="bg-blue-600 text-white p-1 rounded-full mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>OR Bachelor's degree with 4,500 hours of business analysis experience</span>
              </li>
              <li className="flex items-start">
                <span className="bg-blue-600 text-white p-1 rounded-full mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>35 hours of business analysis education</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="text-center py-10 px-4 bg-blue-950 rounded-xl text-white">
          <h2 className="text-2xl font-bold mb-6">Become a Certified Business Analysis Professional</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg transition-colors flex items-center justify-center">
              Enroll in PBA Preparation Program
            </button>
          ...
          <p className="mt-6 text-blue-200">Advance your career with the premier business analysis certification</p>
        </section>
      </div>
    </div>
  );
