  ...
  return (
    <section className="bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative h-[400px] md:h-[500px]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-green-900/45 to-blue-300/45  flex items-center justify-center">
          <div className="text-center px-4">
            ...
            >
              ...
              <button className="bg-white text-blue-300 px-6 py-3 rounded-lg font-bold hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl">
                Enroll Now
              </button>
              </a>
            </motion.div>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="p-8 md:p-10">
                ...
                <div className="prose prose-lg text-gray-700 space-y-4">
                  <p>
                    Our <span className="font-semibold text-blue-300">PMP certification course</span> provides comprehensive training based on the latest PMBOK® Guide, equipping you with the skills to successfully manage projects across industries.
                  </p>
                  <p>
          ...
          <motion.div
            ...
            animate="visible"
            variants={fadeUp}
            className="bg-gradient-to-r from-blue-300 to-blue-800 rounded-2xl shadow-xl overflow-hidden mb-16 text-white"
          >
            <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            >
              <div className="p-8 md:p-10">
                ...
                <div className="space-y-6">
                  <div className="flex">
                    <div className="bg-blue-100 text-blue-300 rounded-full w-8 h-8 flex items-center justify-center mr-4 flex-shrink-0">
                      1
                    </div>
                    <div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-blue-300 to-blue-800 rounded-2xl p-8 text-center text-white shadow-xl"
          >
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-blue-300 px-8 py-3 rounded-lg font-bold hover:bg-blue-50 transition-all shadow-lg">
                  Enroll Now
                </button>
                <Link to={"/contact"}>
