      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Contact <span className="text-blue-950">Global Mind Center</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="bg-blue-50 p-8 md:p-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-8 flex items-center">
                <MessageSquare className="mr-3 text-blue-950" />
                Contact Information
              </h2>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-white p-3 rounded-lg shadow-sm mr-4 text-blue-950">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="inline-block mt-2 text-blue-950 hover:underline text-sm font-medium"
                    >
                      View on Google Maps →
                    </a>
                  </div>
                ...
                <div className="pt-4">
                  ...
                  <div className="flex space-x-4">
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="bg-white p-3 rounded-full shadow-sm text-blue-950 hover:bg-blue-50 transition-colors"
                      aria-label="Facebook"
                    >
            ...
            <div className="p-8 md:p-12">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-950 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center"
                  >
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-blue-950 to-blue-800 rounded-2xl p-8 md:p-12 text-center text-white shadow-xl"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="tel:+250788330905" 
              className="bg-white text-blue-950 px-6 py-3 rounded-lg font-bold hover:bg-blue-50 transition-all shadow-lg"
            >
              Call Now
            </a>
            <a 
